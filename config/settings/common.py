# -*- coding: utf-8 -*-
"""
Django settings for igame-platform project.
...
ROOT_DIR = environ.Path(__file__) - 3  # (igame_platform/config/settings/common.py - 3 = igame_platform/)
APPS_DIR = ROOT_DIR.path('igame_platform')
...
ADMINS = (
    ("""Jhony Avella""", 'jhonyavella90@gmail.com'),
)
