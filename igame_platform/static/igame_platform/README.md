...
This will run all tests in the [`./igame_platform/static/igame_platform/__tests__`][test-dir] directory.
...
Open the lcov-report for an overview of your code coverage:
    ...
    $ open igame_platform/static/igame_platform/dist//reports/coverage/lcov-report/index.html
...
#### Source `./igame_platform/static/igame_platform/`
Main project source.

#### Actions `./igame_platform/static/igame_platform/actions/`
...
#### Components `./igame_platform/static/igame_platform/components/`
React components. Mostly __dumb__ components.

#### Constants `./igame_platform/static/igame_platform/constants/`
Stuff that doesn't change. Redux action types.

#### Containers `./igame_platform/static/igame_platform/containers/`
...
#### Reducers `./igame_platform/static/igame_platform/reducers/`
Reducer functions that take in the _current state_ and an _action type_ then return a new state.

#### Store `./igame_platform/static/igame_platform/store/`
...
[test-dir]: /igame_platform/static/igame_platform/__tests__/
